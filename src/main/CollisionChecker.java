...
public class CollisionChecker {
    ...
    public void checkTile(PlayerEntity entity){
    ...
    public int checkObject(PlayerEntity entity, boolean player) {
        ...
        for (int i = 0; i < gp.obj.length; i++) {
            if (gp.obj[i] != null) {
                ...
                entity.solidArea.x = entity.worldX + entity.solidAreaDX;
                entity.solidArea.y = entity.worldY + entity.solidAreaDY;

                // Get the object's solid area position
                gp.obj[i].solidArea.x = gp.obj[i].worldX + gp.obj[i].solidAreaDX;
                gp.obj[i].solidArea.y = gp.obj[i].worldY + gp.obj[i].solidAreaDY;
