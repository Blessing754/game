...
public class TileManger {
    ...
    public TileManger(GamePanel gp) {
        this.gp = gp;
        tile = new Tile[10]; // this array is used to store the tiles.
    ...
    public void getTileImage(){
        try {
            ...
            tile[0]=new Tile();
            tile[0].image= ImageIO.read(getClass().getResourceAsStream("/tiles/dirt0.png"));
            ...
            tile[4]=new Tile();
            tile[4].image= ImageIO.read(getClass().getResourceAsStream("/tiles/stone4.png"));

            tile[5]=new Tile();
            tile[5].image= ImageIO.read(getClass().getResourceAsStream("/tiles/sand5.png"));

            tile[6]=new Tile();
            tile[6].image= ImageIO.read(getClass().getResourceAsStream("/tiles/tree6.png"));
